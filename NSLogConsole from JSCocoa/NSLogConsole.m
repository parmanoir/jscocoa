...
//	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dataAvailable:) name:NSFileHandleReadCompletionNotification object: fileHandle];
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dataAvailable2:) name:nil object:nil];
...
- (void)dataAvailable2:(NSNotification *)aNotification
{
//	NSData *data = [[aNotification userInfo] objectForKey:NSFileHandleNotificationDataItem];
//	NSLog(@"%@", aNotification);
	printf("****************\n");
